...
List<SettingsModel> get styleSettings => [
  ...
  const SwitchModel(
    title: '「我的」顶栏 · 显示搜索图标',
    subtitle: '仅当主导航不存在首页时生效',
    leading: Icon(Icons.search),
    setKey: SettingBoxKey.showMineSearch,
    defaultVal: true,
    needReboot: true,
  ),
  const SwitchModel(
    ...
    setKey: SettingBoxKey.showMineMsg,
    defaultVal: true,
    needReboot: true,
  ),
  const SwitchModel(
    title: '「我的」顶栏 · 显示评论记录图标',
    subtitle: '仅当登录后生效',
    leading: Icon(Icons.message_outlined),
    setKey: SettingBoxKey.showMineReply,
    defaultVal: true,
    needReboot: true,
  ),
  const SwitchModel(
    title: '「我的」顶栏 · 显示无痕模式图标',
    leading: Icon(MdiIcons.incognito),
    setKey: SettingBoxKey.showMineIncognito,
    defaultVal: true,
    needReboot: true,
  ),
  const SwitchModel(
    title: '「我的」顶栏 · 显示切换账号图标',
    leading: Icon(Icons.switch_account_outlined),
    setKey: SettingBoxKey.showMineSwitchAccount,
    defaultVal: true,
    needReboot: true,
  ),
  const SwitchModel(
    title: '「我的」顶栏 · 显示主题切换图标',
    leading: Icon(Icons.brightness_6_outlined),
    setKey: SettingBoxKey.showMineTheme,
    defaultVal: true,
    needReboot: true,
  ),
  const SwitchModel(
    ...
    setKey: SettingBoxKey.showMineSettings,
    defaultVal: true,
    needReboot: true,
  ),
  const SwitchModel(
    title: '搜索结果聚焦过滤',
    subtitle: '屏蔽过短/爆款/消遣分区视频',
  ...
  NormalModel(
    title: '搜索最短时长',
    getSubtitle: () => '${Pref.searchMinDuration ~/ 60} 分钟,可手工改 box',
    leading: const Icon(Icons.timer_outlined),
    onTap: (context, setState) {},
  ),
  NormalModel(
    title: '搜索最大播放量',
    getSubtitle: () => '${Pref.searchMaxPlayCount ~/ 10000} 万,可手工改 box',
    leading: const Icon(Icons.visibility_outlined),
    onTap: (context, setState) {},
  ),
  NormalModel(
    title: '搜索屏蔽分区',
    getSubtitle: () => Pref.searchBlockedPartitions.join('/'),
